...
- 현재 코드 버전: `260729_revised_speed_task_v29`
- 보관 스냅샷: `FLYWITHLUA_STUDY_INTEGRATED_260729_revised_speed_task_v29.lua`
...
- Java는 `INTRUDER_SPAWNED` 전 1초 입력 baseline 대비 지속 변화를 이용해 `PILOT_RESPONSE_START`, `PILOT_RESPONSE_END`를 자동 기록한다.
