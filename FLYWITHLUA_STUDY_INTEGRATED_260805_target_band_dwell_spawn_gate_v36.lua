...
local STUDY_SCRIPT_VERSION = "260805_target_band_dwell_spawn_gate_v36"
local PARTICIPANT_NOTICE_DURATION_S = 2.5
local TASK_AUDIO_PROTOCOL = "audio_task_v36"
