...
v39 Java/Tobii 통합 6-trial 자료를 이용해 마지막 핵심 분석 기능인 외부시선
공간·객체·의미 classifier를 구현했다. 모니터별 `6 x 3` grid, 매 시각 intruder
dynamic AOI, RKSI runway 34 dynamic polygon과 `INTRUDER/RUNWAY/OTHER/UNRESOLVED`
operational evidence를 생성한다. Lua event와 사후 intruder projection은 sub-pixel
수준으로 일치했다. 다음 단계는 새 기능 추가가 아니라 통제된 표적 주시 또는 화면
녹화와 비교해 semantic accuracy와 `45 px` margin을 동결하는 것이다.
...
- `Agents_updated(260819).md`
- `Project_Context_updated(260819).md`
- `Worklog_updated(260819).md`
