...
v39 slot-1 AI autopilot override의 단일/균형 6-trial physical 검증과 Java/Tobii 통합
6-trial 검증을 완료했다. 통합 세션은 recording clean `6/6`, 조명 재점등 0,
raw gaze valid `70.4%`, trial 동일가중 gaze valid `87.6%`로 engineering PASS다.
현재 다음 구현 단계는 정면 grid와 projected intruder dynamic AOI, runway 영역을 결합한
외부시선 목적 evidence 분류다.
...
- `Agents_updated(260812).md`
- `Project_Context_updated(260812).md`
- `Worklog_updated(260812).md`
