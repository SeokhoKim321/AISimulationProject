...
local STUDY_SCRIPT_VERSION = "260811_geometry_opportunity_calibration_v37"
local PARTICIPANT_NOTICE_DURATION_S = 2.5
local TASK_AUDIO_PROTOCOL = "audio_task_v37"
...
function study_start_intruder_crossing()
    ...
    crossing_lights_write_ok = study_set_intruder_lights(false)
