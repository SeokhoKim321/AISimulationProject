...
local STUDY_SCRIPT_VERSION = "260804_visual_opportunity_bearing_v33"
local PARTICIPANT_NOTICE_DURATION_S = 2.5
local TASK_AUDIO_PROTOCOL = "audio_task_v33"
