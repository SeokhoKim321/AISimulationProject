...
v34 균형 방향 블록 스케줄의 구현·배포·runtime 검증을 완료했다. 이어서
recording clean과 실제 behavior validity를 분리하기 위한 evidence classifier
v1을 구현하고 v33 retry 6-trial에 적용했다. 물리 intruder 조건과
visual-opportunity response anchor는 v33 그대로 유지한다.
