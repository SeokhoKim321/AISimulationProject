...
local STUDY_SCRIPT_VERSION = "260729_random_speed_task_v28"
local PARTICIPANT_NOTICE_DURATION_S = 2.5
local TASK_AUDIO_PROTOCOL = "audio_task_v28"
...
local TASK_AUDIO_OPTIONS = {
    ...
    {
        target_speed_kias = 115,
        file_name = "apisat_task_maintain_115kias_centerline_en_us.wav",
        duration_s = 6.543447
    },
    {
        target_speed_kias = 120,
        file_name = "apisat_task_maintain_120kias_centerline_en_us.wav",
        duration_s = 6.593469
    },
    {
        target_speed_kias = 125,
        file_name = "apisat_task_maintain_125kias_centerline_en_us.wav",
        duration_s = 6.568435
    },
    {
        target_speed_kias = 130,
        file_name = "apisat_task_maintain_130kias_centerline_en_us.wav",
        duration_s = 6.608345
    }
}
