...
local STUDY_SCRIPT_VERSION = "260804_balanced_direction_blocks_v34"
local PARTICIPANT_NOTICE_DURATION_S = 2.5
local TASK_AUDIO_PROTOCOL = "audio_task_v34"
