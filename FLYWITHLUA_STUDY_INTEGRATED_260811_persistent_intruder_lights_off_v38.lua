...
local STUDY_SCRIPT_VERSION = "260811_persistent_intruder_lights_off_v38"
local PARTICIPANT_NOTICE_DURATION_S = 2.5
local TASK_AUDIO_PROTOCOL = "audio_task_v38"
...
function study_intruder_lights_status_detail()
    return string.format(
        "lights_persistent_force=true;lights_readback_ok=%s;lights_all_off=%s;lights_reenabled_count=%d;light_readback_beacon=%.0f;light_readback_nav=%.0f;light_readback_strobe=%.0f;light_readback_landing=%.0f;light_readback_taxi=%.0f",
